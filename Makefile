...
generate-spec-yaml:
	...
	# TODO: Replace the old disable-loadpin and install-lustre-mods initContainers below with lustre-kmod-installer once GKE release specs are updated to use it.
